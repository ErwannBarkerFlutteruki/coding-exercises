...
export function addPriceToProduct(product, price) {
...
export function createUserString(userObj) {
...
export function getAlbumProperties(obj) {
...
export function getAlbumValues(obj) {
  // should take an object with information about an album
...
export function addBandName(array) {
...
export function deletePassword(user) {
  /*
...
export function deleteManyPasswords(users) {
  /*
...
export function countTheObjects(arr) {
  /*
